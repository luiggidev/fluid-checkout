...
**Parameters**
- `$disable` (bool) Whether to disable the place order button. Defaults to `false`.
...
**Parameters**
- `$position` (string) The hook position. Defaults to `'after'`
...
**Parameters**
- `$priority` (int) The hook priority. Defaults to `10`
